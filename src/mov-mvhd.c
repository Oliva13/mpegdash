...
#if defined(DEBUG_LAST1) 
	printf("mov_write_mvhd:mvhd->creation_time - %lld\n", mvhd->creation_time); 
	printf("mov_write_mvhd:mvhd->modification_time - %lld\n", mvhd->modification_time); 
	printf("mov_write_mvhd:mvhd->timescale - %lld\n", mvhd->timescale); 
	printf("mov_write_mvhd:mvhd->duration - %lld\n", mvhd->duration); 
#endif	
